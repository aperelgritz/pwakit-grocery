...
// Contexts
// Alexis custom - added StoreProvider
import {CurrencyProvider, StoreProvider} from '@salesforce/retail-react-app/app/contexts'
...
const App = (props) => {
    ...
    // Alexis custom - timeslot manager
    const {timeslotMgrAuth} = useTimeslotMgr()

    // Alexis custom - get access token for timeslot manager
    useEffect(() => {
        timeslotMgrAuth()
    }, [])
        ...
        <Box className="sf-app" {...styles.container}>
            <StorefrontPreview getToken={getTokenWhenReady}>
                <IntlProvider
                    ...
                    // Alexis custom grocery - hard code fr-FR
                    //locale={targetLocale}
                    locale="fr-FR"
                    messages={messages}
                                ...
                                <Box {...styles.headerWrapper}>
                                    {!isCheckout ? (
                                        <>
                                            ...
                                            >
                                                {/* Alexis custom grocery - removed <HideOnDesktop> to always display hamburger menu */}
                                                {/* <HideOnDesktop>
                                                    <DrawerMenu
                                                        isOpen={isOpen}
                                                        onClose={onClose}
                                                ...
                                                {/* Alexis custom grocery - commented to hide list menu */}
                                                {/* <HideOnMobile>
                                                    <ListMenu
                                                        root={
                                                            categories?.[
