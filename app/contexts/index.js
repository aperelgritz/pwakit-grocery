...
// Alexis custom
// Track selected store & reserved slot in the store locator
export const StoreContext = React.createContext()
export const StoreProvider = ({store: initialStore = '', children}) => {
    ...
    return (
        <StoreContext.Provider
            value={{store, setStore, reservedSlot, setReservedSlot, isLoading, setIsLoading}}
        >
            {children}
        </StoreContext.Provider>
    )
